const ICON_PATHS = {
  ...
  whatsapp: (
    <>
      <path d="M4 20l1.2-4.1A8 8 0 1 1 8.4 19L4 20Z" />
      <path d="M9 9.7c0-.6.4-1 .9-1h.4c.3 0 .5.2.6.4l.6 1.4c.1.3 0 .6-.2.8l-.5.5c.4.9 1.2 1.7 2.1 2.1l.5-.5c.2-.2.5-.3.8-.2l1.4.6c.3.1.4.4.4.7v.4c0 .5-.4.9-1 .9-2.8 0-5-2.2-5-5Z" />
    </>
  ),
  eye: (
    <>
  ...
  eyeOff: (
    <>
      <path d="M3 3l18 18" />
      <path d="M10.6 5.6A10.8 10.8 0 0 1 12 5.5c7 0 10.5 6.5 10.5 6.5a15 15 0 0 1-3.4 4.1M6.5 6.9C3.6 8.8 1.5 12 1.5 12S5 18.5 12 18.5c1.4 0 2.6-.25 3.7-.65" />
  ...
  linkedin: (
    <>
      ...
      <path d="M7.8 11v6" />
      <path d="M12 17v-3.5c0-1.7 1.1-2.8 2.5-2.8s2.5 1.1 2.5 2.8V17" />
      <path d="M12 11v6" />
    </>
  ),
}
