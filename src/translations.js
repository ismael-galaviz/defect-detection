export const translations = {
  en: {
    ...
    calculatorPage: {
      ...
      methodologyNote: "How to use this: add the three annual savings for your total. The defect-reduction savings (point 1) is usually the easiest to defend with data the client already has; points 2 and 3 strengthen the case but depend on the client's operational decisions.",
  ...
  es: {
    ...
    calculatorPage: {
      ...
      methodologyNote: 'Cómo presentarlo: suma los tres ahorros anuales para obtener el total. El ahorro por reducción de defectos (punto 1) suele ser el más fácil de defender con datos que el cliente ya tiene; los puntos 2 y 3 refuerzan el caso pero dependen de decisiones operativas del cliente.',
