      ...
      sections: [
        {
          ...
          fields: [
            ...
            { key: 'volume', label: 'Annual production volume (pieces)' },
            { key: 'costPerDefect', label: 'Cost per defect (MXN)' },
          ],
          hint: 'Ask the client for: the current defect rate (from their quality reports), the expected defect rate with the system (vendor reference or pilot data), and the real cost of a defect — not just material, but rework labor, return logistics, and contractual penalties if any.',
        },
        {
          id: 'laborHours',
          icon: 'clock',
          ...
          hint: 'Important: this savings rarely means layoffs. It usually translates into reassigning staff to higher-value tasks (maintenance, continuous improvement) or avoiding new inspector hires as production grows — present it that way to the client.',
        },
        {
          id: 'lineSpeed',
          icon: 'gauge',
          ...
          hint: 'This savings only applies if the business can sell the extra capacity (enough demand) or if it avoids investing in a second line — worth confirming with the client before including it in the business case. (This calculator converts speed to units using your units-per-meter factor, then applies your margin per unit.)',
        },
      ],
      totalTitle: 'Total estimated savings',
      totalAnnual: 'Total annual savings (sum of the three)',
      recurringCost: 'Recurring annual cost (licenses, maintenance, updates)',
      netAnnual: 'Net annual savings',
      investment: 'Initial investment (MXN)',
      payback: 'Payback period',
      months: 'months',
      paybackNA: 'Add an initial investment to calculate payback',
      methodologyNote: "How to use this: add the three annual savings for your total. Subtract recurring annual costs to get net savings. Divide the initial investment by net annual savings to get payback in months. The defect-reduction savings (point 1) is usually the easiest to defend with data the client already has; points 2 and 3 strengthen the case but depend on the client's operational decisions.",
      ...
      sections: [
        {
          ...
          fields: [
            ...
            { key: 'volume', label: 'Volumen de producción anual (piezas)' },
            { key: 'costPerDefect', label: 'Costo por defecto (MXN)' },
          ],
          hint: 'Qué datos pedirle al cliente: tasa de defectos actual (de sus reportes de calidad), tasa de defectos esperada con el sistema (dato de referencia del proveedor o piloto), y el costo real de un defecto (no solo el material — incluye mano de obra de retrabajo, logística de devolución y, si aplica, penalizaciones contractuales).',
        },
        {
          id: 'laborHours',
          icon: 'clock',
          ...
          hint: 'Nota importante: este ahorro rara vez significa despidos. Generalmente se traduce en reasignar personal a tareas de mayor valor (mantenimiento, mejora continua) o evitar contratar inspectores adicionales al crecer la producción — así conviene presentarlo ante el cliente.',
        },
        {
          id: 'lineSpeed',
          icon: 'gauge',
          ...
          hint: 'Este ahorro solo aplica si el negocio puede vender esa capacidad extra (demanda suficiente) o si evita una inversión en una segunda línea. Vale la pena confirmar esto con el cliente antes de incluirlo en el caso de negocio. (Esta calculadora convierte la velocidad a unidades usando tu factor de unidades por metro, y luego aplica tu margen por unidad.)',
        },
      ],
      totalTitle: 'Ahorro total estimado',
      totalAnnual: 'Ahorro total anual (suma de los tres)',
      recurringCost: 'Costo anual recurrente (licencias, mantenimiento, actualizaciones)',
      netAnnual: 'Ahorro neto anual',
      investment: 'Inversión inicial (MXN)',
      payback: 'Periodo de recuperación (payback)',
      months: 'meses',
      paybackNA: 'Agrega una inversión inicial para calcular el payback',
      methodologyNote: 'Cómo presentarlo: suma los tres ahorros anuales para obtener el total. Resta el costo anual recurrente para obtener el ahorro neto. Divide la inversión inicial entre el ahorro neto anual para obtener el payback en meses. El ahorro por reducción de defectos (punto 1) suele ser el más fácil de defender con datos que el cliente ya tiene; los puntos 2 y 3 refuerzan el caso pero dependen de decisiones operativas del cliente.',
